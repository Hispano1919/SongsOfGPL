...
function d.load()
	...
	Technology:new {
		...
		b = 1,
		unlocked_by = { tec("ground-stone-tools") },
		required_resource = { res("meteoric-iron"), res("native-copper"), res("native-gold"), res("native-silver") },
		research_cost = 0.25,
		required_biome = {},
		required_race = {},
		throughput_boosts = {},
	...
	Technology:new {
		...
		required_resource = { res("copper"), res("gold"), res("silver") },
		research_cost = 1,
		required_biome = {},
		required_race = {},
		throughput_boosts = {},
	...
	Technology:new {
		...
		required_resource = { res("gold"), res("silver"), res("native-gold"), res("native-silver") },
		research_cost = 1,
		required_biome = {},
		required_race = {},
		throughput_boosts = {},
