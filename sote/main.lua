...
BIRTH_NAMES = {
    [BIRTH_RITES.INVALID] = "INVALID",
    [BIRTH_RITES.BLESSING] = "BLESSING",
    [BIRTH_RITES.PURIFICATION] = "PURIFICATION",
    [BIRTH_RITES.OFFERING] = "OFFERING",
    [BIRTH_RITES.NONE] = "NONE"
}

PASSAGE_NAMES = {
    [PASSAGE_RITES.INVALID] = "INVALID",
    [PASSAGE_RITES.COMING_OF_AGE] = "COMING OF AGE",
    [PASSAGE_RITES.MARRIAGE] = "MARRIAGE",
    [PASSAGE_RITES.ASCENSION] = "ASCENSION",
    [PASSAGE_RITES.NONE] = "NONE"
}

DISEASE_NAMES = {
    [DISEASE_RITES.INVALID] = "INVALID",
    [DISEASE_RITES.HEALING_PRAYER] = "HEALING PRAYER",
    [DISEASE_RITES.RITUAL_CLEANSING] = "RITUAL CLEANSING",
    [DISEASE_RITES.SACRIFICE] = "SACRIFICE",
    [DISEASE_RITES.NONE] = "NONE"
}
